...
#define CUST_EINT_KEYMUTE_NUM              2
#define CUST_EINT_KEYMUTE_DEBOUNCE_CN      0
#define CUST_EINT_KEYMUTE_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_KEYMUTE_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
...
#define CUST_EINT_IRQ_NFC_NUM              86
