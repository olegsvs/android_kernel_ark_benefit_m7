...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        .pclk = 58500000,                //record different mode's pclk
        .linelength = 956,                //record different mode's linelength
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x06, 0xde); //c5//5b//78//ae//81//c3//bc //58//c5
	...
	/*Degrid*/
	//write_cmos_sensor(0x8a, 0x0a); //0b //[3:2]\A8\A8\A3\A4??\A1\C1\A8\AE
