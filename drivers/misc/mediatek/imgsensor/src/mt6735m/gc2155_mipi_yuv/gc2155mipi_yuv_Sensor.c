...
#define GC2155MIPI_TEST_PATTERN_CHECKSUM 0x54ddf19b 
...
/*************************************************************************
  ...
  *************************************************************************/
  ...
  UINT32 GC2155MIPISetMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate) {
	...
	SENSORDB("GC2155SetMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",scenarioId,frameRate);
	/*
	switch (scenarioId) {
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			pclk = 134200000;
...
static void GC2155MIPIFlashTriggerCheck(unsigned int *pFeatureReturnPara32) 
{ 
	unsigned int ag; 
	 
	GC2155MIPI_write_cmos_sensor(0xfe,0x00);
	ag = GC2155MIPI_read_cmos_sensor(0x25);
...
UINT32 GC2155MIPISetTestPatternMode(kal_bool bEnable)
{
    SENSORDB("[GC2155SetTestPatternMode]test pattern bEnable:=%d\n",bEnable);
    if(bEnable)
    {
	GC2155MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC2155MIPI_write_cmos_sensor(0xb6, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x80, 0x08); 
	GC2155MIPI_write_cmos_sensor(0x81, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x82, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x03, 0x06); 
	GC2155MIPI_write_cmos_sensor(0x04, 0x40); 
	GC2155MIPI_write_cmos_sensor(0x40, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x5e, 0x00);  
	GC2155MIPI_write_cmos_sensor(0x5f, 0x00);  
	GC2155MIPI_write_cmos_sensor(0x60, 0x00);  
	GC2155MIPI_write_cmos_sensor(0x61, 0x00);  
	...
	GC2155MIPI_write_cmos_sensor(0x64, 0x00);  
	GC2155MIPI_write_cmos_sensor(0x65, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x66, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x67, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x68, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x69, 0x00); 
	GC2155MIPI_write_cmos_sensor(0xb0, 0x60); 
	GC2155MIPI_write_cmos_sensor(0xb1, 0x20); 
	GC2155MIPI_write_cmos_sensor(0xb2, 0x40); 
	GC2155MIPI_write_cmos_sensor(0xb3, 0x40); 
	GC2155MIPI_write_cmos_sensor(0xb4, 0x40); 
	GC2155MIPI_write_cmos_sensor(0xb5, 0x40); 
	GC2155MIPI_write_cmos_sensor(0xfe, 0x02); 
	GC2155MIPI_write_cmos_sensor(0x3c, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x4b, 0x00);  
	GC2155MIPI_write_cmos_sensor(0x49, 0x00);
	GC2155MIPI_write_cmos_sensor(0xdd, 0x00);
	GC2155MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x8c, 0x01);
    }
    else
    {
	GC2155MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC2155MIPI_write_cmos_sensor(0x8c, 0x00);
    }
    return ERROR_NONE;
}
	...
	switch (FeatureId)
	{
		...
		break;
   		case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO: 		
			GC2155MIPIFlashTriggerCheck(pFeatureData32); 
		break;
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN:	        
		       GC2155MIPISetTestPatternMode((BOOL)*pFeatureData16);    
		       break;
		case SENSOR_FEATURE_GET_TEST_PATTERN_CHECKSUM_VALUE:	
		       *pFeatureReturnPara32=GC2155MIPI_TEST_PATTERN_CHECKSUM;
		       *pFeatureParaLen=4;
		       break;
		default:
			break;			
